<?php
    ...
    $query = $miconexion->prepare("select titulo,ruta from dvdybluray order by titulo ASC");
    $query->execute();
...
<head>
    <meta charset="UTF-8">
    <title>Lista Total de Películas Ferroviarias</title>
...
<body>
  <div class="container-progressbar">
   ...
   <div class="background-container">
    ...
    <span id="seleccion" class="active">Haga click en la carátula para ver aquí su titulo</span>
